...
const StudentManagement = () => {
    const [activeTab, setActiveTab] = useState('studentreq');
    return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      ...
      <div>
        {activeTab === 'studentreq' && <StudentRequestManager />}
